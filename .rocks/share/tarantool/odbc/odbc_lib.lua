local odbc_header = require( 'odbc.odbc_header' )
...
--[[
    Tarantool async coio call wrappers
]]
...
ffi.cdef[[
    ...
    SQLRETURN coio_SQLTables(SQLHSTMT StatementHandle,
    ...
    SQLRETURN coio_SQLFetch(SQLHSTMT StatementHandle);
    SQLRETURN coio_SQLExecute(SQLHSTMT StatementHandle);
...
require('odbc.libcoio_odbc')
local odbc_lib = ffi.load('coio_odbc', true)
